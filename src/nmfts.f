...
c---
c         vx(1,i)=acn*vv(1)+  als*vv(2)-3*ast*vv(3)-3*atn*vv(4)
c         vx(2,i)=acn*vv(1)-3*als*vv(2)-3*ast*vv(3)+9*atn*vv(4)
c         vx(3,i)=acn*vv(1)+  als*vv(2)+  ast*vv(3)+  atn*vv(4)
c         vx(4,i)=acn*vv(1)-3*als*vv(2)+  ast*vv(3)-3*atn*vv(4)
c         vx(5,i)=ast*vv(5)+  atn*vv(6)
c         vx(6,i)=ast*vv(5)-3*atn*vv(6)
c---
