...
cat snm/search16.2.in >temp_$(printf %.3f $1)_$(printf %.3f $2)_$3_$4_$5_$6.dat
...
start=`date +%s`
time ./snm/snm.x < temp_$(printf %.3f $1)_$(printf %.3f $2)_$3_$4_$5_$6.dat > out_nm_snm_$(printf %.3f $1)_$(printf %.3f $2)_$3_$4_$5_$6
end=`date +%s`
runtime=$((end-start))

echo runtime $runtime >> out_nm_snm_$(printf %.3f $1)_$(printf %.3f $2)_$3_$4_$5_$6
