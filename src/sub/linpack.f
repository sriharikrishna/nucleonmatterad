c **********************************************************************
c This file contains the LINPACK subroutines and functions:
c      dgeco (subroutine)
c      dgedi (subroutine)
c      dgefa (subroutine)
c      dgesl (subroutine)
c      dsvdc (subroutine)
c      dasum (blas function)
c      daxpy (blas subroutine)
c      ddot  (blas function)
c      dnrm2 (blas function)
c      drot  (blas subroutine)
c      drotg (blas subroutine)
c      dscal (blas subroutine)
c      dswap (blas subroutine)
c      idamax (blas function)
c *id* dgeco ***********************************************************
      ...
      real*8 rcond
c
c     dgeco factors a real matrix by gaussian elimination
