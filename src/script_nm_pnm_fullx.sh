#make -f MakefileTapf clean; make -f Makefile clean; make -f Makefile CASE=pnm prep ; make -f MakefileTapf ALL=1 NUCMAT=1 FULLX=1 CASE=pnm
...
echo $5 >> temp_$1_$2_$3_$4.dat
echo $6 >> temp_$1_$2_$3_$4.dat
echo $7 >> temp_$1_$2_$3_$4.dat
start=`date +%s`
